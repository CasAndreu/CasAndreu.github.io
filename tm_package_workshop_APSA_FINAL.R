...
# Read 3 html files from an online source:

fomc1 <- htmlTreeParse('http://faculty.washington.edu/jwilker/DGo2015/FOMC/FOMC20050322meeting.htm', useInternal = TRUE)
fomc2 <- htmlTreeParse('http://faculty.washington.edu/jwilker/DGo2015/FOMC/FOMC20050809meeting.htm', useInternal = TRUE)
fomc3 <- htmlTreeParse('http://faculty.washington.edu/jwilker/DGo2015/FOMC/FOMC20081216meeting.htm', useInternal = TRUE)

# First create an 'object' (called 'fomc') that includes the 3 html files

fomc <- list (fomc1,fomc2,fomc3) 

# Create a new 'list' (pars) that contains a list of  paragraphs for each of 
#       the three files in docs (using the '/p' delimiter in the html encoding,
